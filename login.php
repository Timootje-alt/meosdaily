...
<head>
  ...
  <meta name="description" content="Dit is een test">
  <meta name="author" content="">
  <title>Inloggen | MEOS</title>
      ...
      <div class="card-body">
		...
		<input type="hidden" name="form" value="<?php if (isset($_GET['2fa'])) { echo '2fa'; } else { echo 'login'; } ?>">
          <div class="form-group">
            <label for="exampleInputEmail1">Jouw gebruikersnaam </label>
          ...
          <div class="form-group">
            <label for="exampleInputPassword1">Jouw wachtwoord: </label>
		  ...
		  <input type="submit" value="Verdergaan" class="btn btn-primary btn-block">
		  <img height="45" src="img/motto.png"><br><br>
		<br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Politie SERVERNAME, SERVERNAME of SERVERNAME RP is op <b>geen enkele manier</b> gelieerd aan Politie Nederland, een van haar dochterorganisaties of partners. De gegevens die in dit systeem zijn opgeslagen zijn volledig fictief en uitsluitend voor spelgerelateerd gebruik. Rechten voor het logogebruik van de politie zijn voorbehouden aan Politie Nederland en de door haar aangewezen organisaties of personen. Alle overige rechten zijn allen voorbehouden aan SERVERNAME RP.</p>
      </div>
